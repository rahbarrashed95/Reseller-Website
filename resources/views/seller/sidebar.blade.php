      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('seller.all-order') || Route::is('seller.order-show') || Route::is('seller.pending-order') || Route::is('seller.pregress-order') || Route::is('seller.delivered-order') ||  Route::is('seller.completed-order') || Route::is('seller.declined-order') || Route::is('seller.cash-on-delivery')  ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ Route::is('seller.process-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.process-order') }}">Process Orders</a></li>
              <li class="{{ Route::is('seller.courier-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.courier-order') }}">Courier Orders</a></li>
              <li class="{{ Route::is('seller.onhold-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.onhold-order') }}">On Hold Orders</a></li>
              ...
              <li class="{{ Route::is('seller.cancell-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.cancell-order') }}">Cancell Orders</a></li>
              <li class="{{ Route::is('seller.return-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.return-order') }}">Return Orders</a></li>
              <li class="{{ Route::is('seller.partial-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.partial-order') }}">{{__('Partial Orders')}}</a></li>
          ...
          <li class="{{ Route::is('seller.inventory') || Route::is('seller.stock-history') ? 'active' : '' }}"><a class="nav-link" href="{{ route('seller.earns') }}"><i class="fas fa-th-large"></i> <span>{{__('Seller Earning')}}</span></a></li>

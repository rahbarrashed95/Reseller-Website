...
<li class="{{ Route::is('admin.report.order') ? 'active' : '' }}">
          ...
          <p class="s-divide">{{__('Sellers Data')}}</p>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.all-order') || Route::is('admin.order-show') || Route::is('admin.pending-order') || Route::is('admin.pregress-order') || Route::is('admin.delivered-order') ||  Route::is('admin.completed-order') || Route::is('admin.declined-order') || Route::is('admin.cash-on-delivery')  ? 'active' : '' }}">
           ...
           <span style="color:black">{{__('Seller Orders')}}</span></a>
            <ul class="dropdown-menu">

              <li class="{{ Route::is('admin.all-order') || Route::is('admin.order-show') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-all-order') }}">{{__('admin.All Orders')}}</a></li>

              <li class="{{ Route::is('admin.seller-pending-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-pending-order') }}">{{__('admin.Pending Orders')}}</a></li>

              <li class="{{ Route::is('admin.seller-processing-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-processing-order') }}">Process Orders</a></li>

              <li class="{{ Route::is('admin.seller-courier-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-courier-order') }}">Courier Orders</a></li>
              <li class="{{ Route::is('admin.seller-onhold-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-onhold-order') }}">On Hold Orders</a></li>
              <li class="{{ Route::is('admin.seller-completed-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-completed-order') }}">{{__('admin.Completed Orders')}}</a></li>
              <li class="{{ Route::is('admin.seller-invoiced-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-invoiced-order') }}">Invoiced Orders</a></li>
              <li class="{{ Route::is('admin.seller-cancell-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-cancell-order') }}">Cancell Orders</a></li>
              <li class="{{ Route::is('admin.seller-return-order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.seller-return-order') }}">Return Orders</a></li>

              <li class="{{ Route::is('admin.cash-on-delivery') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.cash-on-delivery') }}">{{__('admin.Cash On Delivery')}}</a></li>
              <li class="{{ Route::is('admin.report.order') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.order.report') }}">Report</a></li>
            </ul>

          </li>
          @endif
          
        <li class="{{ Route::is('admin.sellers-report') || Route::is('admin.sellers-report') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.sellers-report') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Sellers Report')}}</span>
            </a>
        </li>
        
        <li class="{{ Route::is('admin.orders-invoice') || Route::is('admin.orders-invoice') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.orders-invoice') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Orders Invoice')}}</span>
            </a>
        </li>
        
        <li class="{{ Route::is('admin.seller-generate-order') || Route::is('admin.seller-generate-order') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.seller-generate-order') }}">
            <div class="icon">
                <i class="fas fa-money-check-alt"></i>
            </div>
            <span style="color:black">{{__('Generate Invoice')}}</span>
            </a>
        </li>
        ...
        @if(auth()->user()->can('admin.product') || auth()->user()->can('admin.product-brand.index') || auth()->user()->can('admin.product-variant') || auth()->user()->can('admin.create-product-variant') || auth()->user()->can('admin.edit-product-variant') || auth()->user()->can('admin.product-gallery') || auth()->user()->can('admin.product-variant-item	') || auth()->user()->can('admin.create-product-variant-item') || auth()->user()->can('admin.edit-product-variant-item') || auth()->user()->can('admin.product-review') || auth()->user()->can('admin.show-product-review'))
          ...
          @if(auth()->user()->can('admin.flash-sale-product') || auth()->user()->can('admin.flash-sale-product') || auth()->user()->can('admin.about-us.index'))
          ...
          <p class="s-divide">{{__('admin.Shop Setup')}}</p>
            ...
            <span style="color:black">{{__('admin.Ecommerce')}}</span></a>
            <ul class="dropdown-menu">

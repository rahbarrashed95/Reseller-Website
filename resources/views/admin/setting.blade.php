                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="google-analytic-tab" data-toggle="tab" href="#googleAnalyticTab" role="tab" aria-controls="googleAnalyticTab" aria-selected="true">{{__('Google Analytic Header')}}</a>
                                        </li>
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="pixel-tab-third" data-toggle="tab" href="#PixelTabThird" role="tab" aria-controls="PixelTabThird" aria-selected="true">{{__('Google Analytic Body')}}</a>
                                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="phone2" class="form-control" value="{{ $footer->phone2 }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="open" class="form-control" value="{{ $footer->open }}">
                                </div>
                                
                                <div class="form-group col-12">
                                    <label>Off Day:</label>
                                    <input type="text" name="holiday" class="form-control" value="{{ $footer->holiday }}">
                                </div>
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('user.update-google-analytic') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" style="height: 160px;" name="analytic_id">{{ $googleAnalytic->analytic_id }}</textarea>
                                            ...
                                            <div class="tab-pane fade" id="facebookPixelTab" role="tabpanel" aria-labelledby="facebook-pixel-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('user.update-facebook-pixel') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Facebook App Id')}}</label>
                                                                <textarea class="form-control" style="height: 160px;" name="app_id">{{ $facebookPixel->app_id }}</textarea>
                                                            </div>
                                                            <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                                    </form>
                                                    </div>
                                            ...
                                            <div class="tab-pane fade" id="PixelTabThird" role="tabpanel" aria-labelledby="pixel-tab-third">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('user.update-site-pixel') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Allow Tracking Pixel')}}</label>
                                                                <div>
                                                                    @if ($sitePixel->status == 1)
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('Site Tracking Pixel Code')}}</label>
                                                                <textarea class="form-control" style="height: 160px;" name="pixel_id">{{ $sitePixel->pixel_id }}</textarea>
                                                            </div>
                                                            <button class="btn btn-primary">{{__('admin.Update')}}</button>
                                                    </form>
                                                    </div>

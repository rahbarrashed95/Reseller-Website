        ...
        <div class="col-lg-12" id="product_search" style="display: none;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table table-centered table-nowrap mb-0" id="product_table">
                                ...
                                <tbody id="data">
                                   <tr>
                                       <td><img src="{{ asset('public/products/'.$single_product->thumb_image) }}" height="50" width="50"/></td>
                                      
                            		    <td>{{ $single_product->name }}</td>
                                        
                                        <td><a class="remove btn btn-sm btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>

                        ...
                        <form action="{{ route('admin.product.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="product_id" required value="{{ $product->id }}">
                                ...
                                <div class="form-group col-4">
                                   ...
                                   <input type="text" class="form-control" name="wholesell_price" value="{{ $product->wholesell_price }}">
                                </div>
                                ...
                                <div class="form-group col-4">
                                   ...
                                   <input type="text" class="form-control" name="supplier_name" value="{{ $product->supplier_name }}">
                                </div>
                                    ...
                                    <table class="table table-centered table-nowrap table-bordered text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="action-icon btn btn-primary add_moore">Add</a>
                                                    <a class="action-icon btn btn-danger remove">Delete </a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>

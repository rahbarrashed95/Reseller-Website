                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-12">
                                    ...
                                    <select name="order_status" class="form-control select2" id="brand">
                                      ...
                                      <option {{ $order->order_status == 8 ? 'selected' : '' }} value="8">Partials Orders</option>
                                    </select>
                                </div>
                                </div>
                                  </div>
                                ...
                                <tbody id="data">
                                    @foreach($order->orderProducts as $products)
                                        <tr>
                                          ...
                                          <td>
                                            @if($products->resell_price == null)
                                            <input type="number" class="form-control resell_price" name="resell_price[]" value="{{ $products->unit_price }}" />
                                            @else
                                            <input type="number" class="form-control resell_price" name="resell_price[]" value="{{ $products->resell_price }}" />
                                            @endif
                                        </td>
                                          <td>
                                          ...
                                          @if($products->resell_price == null)
                                           ...
                                           @else
                                           <td class="row_total">{{$products->resell_price * $products->qty}}</td>
                                           @endif
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="shipping_phone" class="form-control"  name="shipping_phone" value="{{ $order->orderAddress->shipping_name }}">
                                </div>
                              </div>
...
<script>
  ...
  $(document).on('blur change',".quantity",function(e) {
    ...
    $(document).on('blur',".quantity, .resell_price",function(e) {
     calculateSum();
    });
    ...
    function calculateSum() {
        ...
        tblrows.each(function (index) {
            ...
            let amount=Number(tblrow.find('td input.resell_price').val());

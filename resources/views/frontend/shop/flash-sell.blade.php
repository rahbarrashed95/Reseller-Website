                ...
                @endif
                    ...
                    <a class="secondary_img " href="{{ route('front.product.show', [ $product->product->id ] ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->product->thumb_image) }}" style="margin-left:5%" class="seccusImg" alt=""></a>
                                ...
                                <div class="product_content " style="border-top:3px solid #EDEDEF; margin-top: 10%; ">
                                    ...
                                    <span class="current_price">{{$product->product->wholesell_price}} Tk</span>
                                    <input type="hidden" name="wholesell_price" id="wholesell_price" value="{{ $product->product->wholesell_price }}">
                                    @else
                       ...
                       <!-- </a>-->
                                     ...
                                     {{ BanglaText('order') }}
                                      ...
                                      <a style="color: white; font-size: 16px;background: red;border: solid;width: 100%;padding-top: 4%;" type="button" data-productid="{{ $product->product->id }}" data-proprice="{{ $product->product->wholesell_price }}"
                    data-proname="{{ $product->product->name }}"
                    class="btn btn-primary open-modal" data-bs-toggle="modal" data-bs-target="#productModal-{{ $product->product->id }}">

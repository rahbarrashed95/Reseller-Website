...
use App\Http\Controllers\WEB\Admin\sellerAccountController;
use App\Http\Controllers\WEB\Admin\orderPaymentController;
...
use App\Http\Controllers\WEB\Seller\sellerEarnController;
...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    Route::get('seller/register', [SellerLoginController::class,'storeRegister'])->name('seller.register');
    Route::post('seller/register', [SellerLoginController::class,'storeRegisterPost'])->name('seller.register');
    ...
    Route::group(['as'=> 'seller.', 'prefix' => 'seller'],function (){
        ...
        Route::get('process-order', [SellerOrderController::class, 'processOrder'])->name('process-order');
        Route::get('courier-order', [SellerOrderController::class, 'courierOrder'])->name('courier-order');
        Route::get('onhold-order', [SellerOrderController::class, 'onholdOrder'])->name('onhold-order');
        Route::get('completed-order', [SellerOrderController::class, 'completedOrder'])->name('completed-order');
        Route::get('cancell-order', [SellerOrderController::class, 'cancellOrder'])->name('cancell-order');
        Route::get('return-order', [SellerOrderController::class, 'returnOrder'])->name('return-order');
        Route::get('partial-order', [SellerOrderController::class, 'partialOrder'])->name('partial-order');
        ...
        Route::get('order-edit/{id}',[SellerOrderController::class, 'edit'])->name('order-edit');
        ...
        // Seller Earn
        Route::get('/seller/earn', [sellerEarnController::class, 'show_seller_earn'])->name('earns');
        //Seller Invoice Generate
        Route::get('/seller/invoice/{order_id}', [sellerEarnController::class, 'seller_invoice'])->name('seller_invoice');
    });
});
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::get('generate/barcode/{id}',[ProductController::class,'product_barcode'])->name('product-barcode');
    ...
    Route::get('seller-all-order', [OrderController::class, 'index_seller'])->name('seller-all-order');
    Route::get('seller-wise-order', [OrderController::class, 'seller_wise_order'])->name('seller-wise-order');
    Route::get('seller-wise-generate-order', [OrderController::class, 'seller_wise_generate_order'])->name('seller-wise-generate-order');

    Route::get('seller-pending-order', [OrderController::class, 'seller_pending_seller'])->name('seller-pending-order');
    Route::get('seller-processing-order', [OrderController::class, 'seller_processing_seller'])->name('seller-processing-order');
    Route::get('seller-courier-order', [OrderController::class, 'seller_courier_seller'])->name('seller-courier-order');
    Route::get('seller-onhold-order', [OrderController::class, 'seller_onhold_seller'])->name('seller-onhold-order');
    Route::get('seller-completed-order', [OrderController::class, 'seller_completed_seller'])->name('seller-completed-order');
    Route::get('seller-invoiced-order', [OrderController::class, 'seller_invoiced_seller'])->name('seller-invoiced-order');
    Route::get('seller-cancell-order', [OrderController::class, 'seller_cancell_seller'])->name('seller-cancell-order');
    Route::get('seller-return-order', [OrderController::class, 'seller_return_seller'])->name('seller-return-order');
    
    Route::get('seller-generate-order', [OrderController::class, 'seller_generate_order'])->name('seller-generate-order');
    
    
    
    

    Route::get('invoice-generate', [OrderController::class, 'generate_invoice'])->name('generate_invoice');
    ...
    // Seller Earn
    Route::get('/individual/seller/earn/{id}', [OrderController::class, 'show_individual_seller_earn'])->name('earns');

    Route::get('/order/payment/{seller_id}/{unique_id}', [orderPaymentController::class, 'order_payment'])->name('order-payment');
    Route::post('/pay/order', [orderPaymentController::class, 'pay_order'])->name('pay_order');

    Route::get('sellers-report', [sellerAccountController::class, 'sellersReport'])->name('sellers-report');
    ...
    Route::get('oroders-invoice', [OrderController::class, 'orders_invoice'])->name('orders-invoice');
    Route::get('oroders-invoice', [OrderController::class, 'orders_invoice'])->name('orders-invoice');

    Route::get('order-invoice-show/{seller_id}/{unique_key}', [OrderController::class, 'order_invoice_show'])->name('order-invoice-show');
    ...
    Route::post('generate-access-token', [OrderController::class, 'generatePathaoAccessToken'])->name('generate-access-token');

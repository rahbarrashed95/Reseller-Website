...
class SettingController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.setting',compact('footer', 'setting','cookieConsent','googleRecaptcha','facebookComment','tawkChat','googleAnalytic','customPaginations','socialLogin','facebookPixel','currencies','pusher','sitePixel'));
    }
    
    public function courier_index() {
        $info = Information::first();
        
        return view('admin.Courier_Settings.index', compact('info'));
    }
    ...
    public function updateCourierSetting(Request $request) {
        ...
        $information = Information::findOrFail($request->courier_id);
    ...
    public function viewAccessToken() {
        return view('admin.Courier_Settings.view_access_token');
    }
    ...
    public function updatePixelFacebook(Request $request) {
        dd($request->all());
    }
